...
CREATE TABLE "public.Programs/Tools" (
	...
	CONSTRAINT "Programs/Tools_pk" PRIMARY KEY ("tools_id")
) WITH (
  OIDS=FALSE
);
...
ALTER TABLE "Day" ADD CONSTRAINT "Day_fk2" FOREIGN KEY ("challenge_id") REFERENCES "Code Challenge"("challenge_id");
ALTER TABLE "Day" ADD CONSTRAINT "Day_fk3" FOREIGN KEY ("codewars_id") REFERENCES "CodeWars"("codewars_id");
ALTER TABLE "Day" ADD CONSTRAINT "Day_fk4" FOREIGN KEY ("tools_id") REFERENCES "Programs/Tools"("tools_id");
